...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return DynamicOuterClass.internal_static_bilibili_app_dynamic_v1_DynDetailsReply_descriptor;
  }

  @Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return DynamicOuterClass.internal_static_bilibili_app_dynamic_v1_DynDetailsReply_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            DynDetailsReply.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof DynDetailsReply)) {
      return super.equals(obj);
    }
    DynDetailsReply other = (DynDetailsReply) obj;
  ...
  public static DynDetailsReply parseFrom(
  ...
  public static DynDetailsReply parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static DynDetailsReply parseFrom(
  ...
  public static DynDetailsReply parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DynDetailsReply parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static DynDetailsReply parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(DynDetailsReply prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.bapis.bilibili.app.dynamic.v1.DynDetailsReply.newBuilder()
    private Builder() {
    ...
    @Override
    public DynDetailsReply getDefaultInstanceForType() {
      return DynDetailsReply.getDefaultInstance();
    }

    @Override
    public DynDetailsReply build() {
      DynDetailsReply result = buildPartial();
    ...
    @Override
    public DynDetailsReply buildPartial() {
      DynDetailsReply result = new DynDetailsReply(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DynDetailsReply) {
        return mergeFrom((DynDetailsReply)other);
      } else {
    ...
    public Builder mergeFrom(DynDetailsReply other) {
      if (other == DynDetailsReply.getDefaultInstance()) return this;
      if (listBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      DynDetailsReply parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (DynDetailsReply) e.getUnfinishedMessage();
  ...
  static {
    DEFAULT_INSTANCE = new DynDetailsReply();
  }
